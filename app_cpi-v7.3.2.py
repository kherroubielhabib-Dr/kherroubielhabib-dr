# ═══════════════════════════════════════════════════════════════════
# مؤشر التلاقح المعرفي - CPI Dashboard v7.3.2
# Cross-Pollination Index · Indice de Pollinisation Croisée
# د. الحبيب خروبي · ESU-001
# الإصدار: v7.3.2 - الترجمة الكاملة الشاملة (بدون أي نصوص ثابتة)
# ═══════════════════════════════════════════════════════════════════
...
st.set_page_config(
    page_title="CPI Dashboard v7.3.2",
    page_icon="🧠",
    layout="wide",
...
# ════════════════════════════════════════════════════════════════════
# 3. قاموس الترجمة المركزي الكامل (مع الإضافات الجديدة)
# ════════════════════════════════════════════════════════════════════

TRANSLATIONS = {
    # التطبيق
    "app_title": {"ar": "مؤشر التلاقح المعرفي", "en": "Cross-Pollination Index", "fr": "Indice de Pollinisation Croisée"},
    "app_sub": {"ar": "CPI Dashboard v7.3.2 · د. الحبيب خروبي · ESU-001", "en": "CPI Dashboard v7.3.2 · Dr. Elhabib Kherroubi · ESU-001", "fr": "Tableau de bord CPI v7.3.2 · Dr. Elhabib Kherroubi · ESU-001"},
...
# ════════════════════════════════════════════════════════════════════
# 4. البيانات الأساسية (كما هي بدون تغيير)
# ════════════════════════════════════════════════════════════════════
...
# ════════════════════════════════════════════════════════════════════
# 5. دوال المساعدة (كما هي بدون تغيير)
# ════════════════════════════════════════════════════════════════════
...
# ════════════════════════════════════════════════════════════════════
# 11. TAB 4: الميسر المعرفي (مع التصحيح)
# ════════════════════════════════════════════════════════════════════
...
<div style="text-align:center; margin-top:48px; padding:20px; background:linear-gradient(135deg,#0F172A,#1E293B); border-radius:16px;">
    ...
    <div style="font-size:11px; color:#64748B; font-family:monospace;">CPI Framework v7.3.2 · CI = NK × EH · {datetime.datetime.now().year}</div>
</div>
''', unsafe_allow_html=True)
