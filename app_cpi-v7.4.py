# ═══════════════════════════════════════════════════════════════════
# مؤشر التلاقح المعرفي - CPI Dashboard v7.4
# Cross-Pollination Index · Indice de Pollinisation Croisée
# د. الحبيب خروبي · ESU-001
# الإصدار: v7.4 - النسخة النهائية الاحترافية
# ═══════════════════════════════════════════════════════════════════
...
TRANSLATIONS = {
    ...
    "app_sub": {"ar": "CPI Dashboard v7.4 · د. الحبيب خروبي · ESU-001", "en": "CPI Dashboard v7.4 · Dr. Elhabib Kherroubi · ESU-001", "fr": "Tableau de bord CPI v7.4 · Dr. Elhabib Kherroubi · ESU-001"},
    ...
    "delete_btn": {"ar": "🗑️ حذف", "en": "🗑️ Delete", "fr": "🗑️ Supprimer"},
...
with tab5:
    st.markdown(f'<div style="background:linear-gradient(135deg,#0F172A,#1E293B); color:white; border-radius:16px; padding:24px; margin-bottom:20px;"><div style="display:flex; align-items:center; gap:12px;"><div style="font-size:28px;">📜</div><div><div style="font-size:18px; font-weight:800;">ميثاق التلاقح المعرفي</div><div style="font-size:11px; color:#94A3B8;">الإصدار 1.1 · د. الحبيب خروبي · ESU-001 · جوان 2026</div></div></div><div style="font-size:13px; color:#CBD5E1; background:rgba(255,255,255,0.05); border-radius:10px; padding:12px; margin-top:12px;">انطلاقاً من أن الابتكار الحقيقي لا ينتج عن تجميع المعارف الفردية بصورة منفصلة، بل عن التفاعل المنهجي بينها وتحويل الاختلافات المعرفية إلى طاقة إبداعية مشتركة --- نعتمد هذا الميثاق عقداً معرفياً وأخلاقياً وتشغيلياً لفريقنا.</div></div>', unsafe_allow_html=True)
    
    st.markdown(f'<div style="background:#FFF7ED; border:1.5px solid #FCD34D; border-radius:14px; padding:18px; margin-bottom:22px; text-align:center;"><div style="font-size:11px; font-weight:700; color:#92400E; margin-bottom:8px;">المبدأ المحوري</div><div style="font-size:15px; font-weight:700; color:#78350F;">❝ التواضع المعرفي ليس مجرد فضيلة أخلاقية، بل بنية تشغيلية لازمة لظهور الذكاء الجماعي. ❞</div><div style="font-size:12px; font-family:monospace; color:#B45309; margin-top:10px;">CI = NK × EH</div></div>', unsafe_allow_html=True)
...
<div style="text-align:center; margin-top:48px; padding:20px; background:linear-gradient(135deg,#0F172A,#1E293B); border-radius:16px;">
    ...
    <div style="font-size:11px; color:#64748B; font-family:monospace;">CPI Framework v7.4 · CI = NK × EH · {datetime.datetime.now().year}</div>
</div>
''', unsafe_allow_html=True)
